...
export default function ExecutiveTemplate({
  ...
  return (
    <div className="resume-template">
      {/* Page 1 */}
      <div className="resume-page flex min-h-[1123px] w-full overflow-hidden rounded-sm text-slate-800 font-sans select-text max-w-full">
      ...
      {page2Sections.length > 0 && (
        <>
          ...
          <div className="resume-page resume-page-continuation flex min-h-[1123px] w-full overflow-hidden rounded-sm text-slate-800 font-sans select-text max-w-full">
            {/* Left Sidebar (32% width) - Light Grey Panel */}
            <div className="w-[32%] bg-[#f2f2f2] text-slate-850 p-5 flex flex-col gap-6 shrink-0 sidebar-column no-print-background-hack">
              {page2Left.map((secId) => {
                const component = leftSectionsMap[secId]
