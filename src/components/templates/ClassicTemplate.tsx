...
export default function ClassicTemplate({ 
  ...
  return (
    <div className="resume-template">
      {/* Page 1 */}
      <div className="resume-page font-serif text-[10pt] leading-normal text-slate-800 p-10 select-text max-w-full space-y-6" style={{ paddingTop: 48, paddingBottom: 48 }}>
      ...
      {page2Sections.length > 0 && (
        <>
          ...
          <div className="resume-page resume-page-continuation font-serif text-[10pt] leading-normal text-slate-800 p-10 select-text max-w-full space-y-6" style={{ paddingTop: 48, paddingBottom: 48 }}>
